...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [11523095.660524, -189011.721527, 11543621.534506, -169299.100707], maxZoom: 1, minZoom: 1
    })
});
...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Tutupan_Lahan_2019_1,
      colName: 'QName19',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([11523095.660524, -189011.721527, 11543621.534506, -169299.100707], map.getSize());
