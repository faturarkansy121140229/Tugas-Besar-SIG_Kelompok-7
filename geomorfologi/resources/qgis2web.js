...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [11519839.602178, -192472.848604, 11544789.778221, -170531.462039], maxZoom: 1, minZoom: 1
    })
});
...
map.getView().fit([11519839.602178, -192472.848604, 11544789.778221, -170531.462039], map.getSize());
