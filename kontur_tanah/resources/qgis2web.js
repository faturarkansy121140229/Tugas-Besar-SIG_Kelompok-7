...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [11517629.100740, -189850.043331, 11546067.766399, -170207.458412], maxZoom: 1, minZoom: 1
    })
});


map.getView().fit([11517629.100740, -189850.043331, 11546067.766399, -170207.458412], map.getSize());
